...
css();patchReport();const ob=new MutationObserver(()=>{install();paintRates();patchReport()});ob.observe(document.documentElement,{childList:true,subtree:true});install();paintRates();setInterval(patchReport,250);
})();